...
export default function App() {
  ...
  return <AppLayout activePage={page} setActivePage={setPage} onAdd={() => setEditing({})}>{page === 'Categories' ? <CategoryOverview tasks={tasks} onOpenCategory={openCategory}/> : tasksView}{editing && <TaskFormModal task={editing.id ? editing : null} onClose={() => setEditing(null)} onSave={save}/>} {showAi && <AiPlanner tasks={todayTasks} onClose={() => setShowAi(false)}/>}</AppLayout>;
}
